...
# Patch the service file's ExecStart path to match the actual install directory.
sudo sed -i "s|/home/pi/displayboard|$PROJECT_DIR|g" /etc/systemd/system/displayboard-wifi.service
